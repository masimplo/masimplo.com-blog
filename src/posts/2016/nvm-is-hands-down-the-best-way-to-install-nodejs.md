---
layout: post
title: Install and switch Node.js versions with nvm
author: [masimplo]
tags: [Tools, Tips]
image: ../../images/headers/sven-read-623749-unsplash.jpg
date: 2016-11-02
draft: false
excerpt: NVM is still the easiest way to install Node.js, switch versions instantly, and migrate global packages when you upgrade.
---

With NodeJS rapidly releasing newer version since the node community got back on its feet, it is now necessary to have an easy way to maintain your [NodeJS](https://nodejs.org/) installations.

I have tried many different ways to install and maintain Node, distribution packages, binary downloads, building from source and finally using [NVM](https://github.com/nvm-sh/nvm). I know that each method has its advantages and disadvantages, but I now have a favourite.
...
Grab the install script from the current [nvm release](https://github.com/nvm-sh/nvm#installing-and-updating) (version numbers below are examples — check the repo for the latest tag):

`curl -o- https://raw.githubusercontent.com/nvm-sh/nvm/v0.40.1/install.sh | bash`

## Install and switch Node versions

Then install any version of node simply by writing
...
## Migrate global packages to a new Node version
...
How is that for easy migration of node versions!? To see what you currently have installed globally before migrating, [list them with `npm ls -g`](/listing-global-npm-installed-packages/).

## Remove a system-wide Node install
