---
layout: post
title: Add highlight.js to Ghost with Code Injection
author: [masimplo]
tags: [Blogging, Tips]
image: ../../images/headers/highlighted-code.png
date: 2016-10-17
draft: false
excerpt: Paste highlight.js CSS and script into Ghost Admin Code Injection — no theme file edits required for syntax highlighting.
---
...
Related: [run Ghost in Docker behind nginx](/running-ghost-inside-docker-behind-nginx/).
