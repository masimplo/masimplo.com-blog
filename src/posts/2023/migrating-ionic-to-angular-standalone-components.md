---
layout: post
title: Ionic Angular standalone components — migrating 500+ components
author: [masimplo]
tags: [Ionic, Code]
image: ../../images/headers/bernd-dittrich-pivF3guSUgI-unsplash.jpg
date: 2023-03-05
draft: false
excerpt: How I migrated an Ionic Angular app with 500+ components to standalone using the official schematic, plus the routing and provider fixes that still needed a human.
---
...
## Run the Angular standalone schematic
