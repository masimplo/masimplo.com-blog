---
layout: post
title: Voron bed mesh looks warped — check the gantry first
author: [masimplo]
tags: [3D Printing, Hobbies]
image: ../../images/headers/bed-mesh.png
date: "2023-01-18"
draft: false
excerpt: My Voron bed mesh jumped to 0.32mm and I assumed a warped MIC-6 plate. Calipers said the gantry was out of parallel — fixed without replacing the bed.
---
...
## When the bed mesh suddenly looks bad
...
That kind of ongoing ownership is the real Voron project — I wrote more about [what happens after the build high wears off](/voron-build-vs-maintenance/).
