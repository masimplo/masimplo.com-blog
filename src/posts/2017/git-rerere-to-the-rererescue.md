---
layout: post
title: Enable git rerere so rebase conflicts resolve themselves
author: [masimplo]
tags: [Tips, Tools]
image: ../../images/headers/abraham-osorio-184519.jpg
date: 2017-10-18
draft: false
excerpt: Turn on git rerere and git remembers how you resolved a conflict — repeated rebases of a feature branch stop asking you to fix the same thing twice.
---
...
## What git rerere does

Turns out git has yet another hidden feature (or not so much advertised anyway). Enter git rerere which stands for **R**euse **R**ecorded **R**esolution. Rerere is a config option rather than a command (there is a command also but serves for advanced usage of recorded resolutions and not enabling/disabling the feature).

## Enable rerere

To enable rerere just do:
...
Related: [bulk-delete remote and local git tags](/removing-remote-and-local-git-tags/) when the history cleanup is about tags instead of conflicts.
